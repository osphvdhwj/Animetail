...
class SecurityPreferences(
    ...
    fun useAuthenticator() = useAuthenticator
    fun lockAppAfter() = lockAppAfter
    fun secureScreen() = secureScreen
    fun hideNotificationContent() = hideNotificationContent
    fun lastAppClosed() = lastAppClosed
